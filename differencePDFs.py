...
class PDFdiff:
    ...
    def __resamplePDFs__(self,X1,pX1,X2,pX2):
        ...
        '''
        I1 = interp1d(X1,pX1,kind='linear',
            bounds_error=False,fill_value=0)
        I2 = interp1d(X2,pX2,kind='linear',
            bounds_error=False,fill_value=0)
    ...
    def plot(self,title=None):
        ...
        self.axRaw.plot(self.x,self.pX1,
            color='b', linewidth=2, label='PDF1')
        self.axRaw.plot(self.x,self.pX2,
            color='g', linewidth=2, label='PDF2')
        self.axRaw.legend()

        # Plot difference
        self.axDiff = self.Fig.add_subplot(212)
        self.axDiff.plot(self.D,self.pD,
            color = 'k', linewidth=3, label = 'difference')
