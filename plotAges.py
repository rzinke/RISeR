...
def createParser():
    ...
    parser.add_argument(dest='datesList', type=str,
        help='File with list of dates.')
    parser.add_argument('-d','--date-offset', dest='dateOffset', default=None, type=int,
        help='Reference age for date (e.g., 2019)')
    parser.add_argument('-c','--scale', dest='scale', default=1.0, type=float,
        help='Vertical scale for PDFs')
    parser.add_argument('-s','--smoothing', dest='smoothing', default=None, type=int,
        help='If selected, specify kernel width')
