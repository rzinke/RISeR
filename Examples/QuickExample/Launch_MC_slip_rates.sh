...
makePDF.py -d gauss -v 6.0 1. -o T2T3age

makePDF.py -d gauss -v 10. 1. -o T1T2age
...
makePDF.py -d trap -v 7.0 8.0 10. 11. -o T2T3offset

makePDF.py -d tri -v 12. 15. 16. -o T1T2offset
...
Nsamples=10000    # number of valid samples
...
Confidence=95.45  # percent confidence to report
PlotMax=10        # maximum of incr. slip rate plot

calcSlipRates.py Inputs.yaml -o $Outname -n $Nsamples \
--pdf-method $PDFmethod --pdf-analysis $PDFanalysis --rate-step $SlipRateStep \
